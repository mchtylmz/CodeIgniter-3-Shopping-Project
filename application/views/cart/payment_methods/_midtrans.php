    ...
    try {
        ...
        $params = array(
            'transaction_details' => array(
                'order_id' => $mc20bt99_payment_token,
                ...
                onSuccess: function (result) {
                    if (result.status_code == 200) {
                        var data_array = {
                            ...
                            'mc20bt99_payment_type': '<?= $mc20bt99_payment_type; ?>',
                            'sys_lang_id': mc20bt99_config.sys_lang_id
                        };
                        data_array[mc20bt99_config.csfr_token_name] = $.cookie(mc20bt99_config.csfr_cookie_name);
                        $.ajax({
                            type: "POST",
