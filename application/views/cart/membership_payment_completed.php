...
if(!empty($this->session->userdata('mc20bt99_membership_bank_transaction_number'))){
    $this->session->unset_userdata('mc20bt99_membership_bank_transaction_number');
}
if (!empty($this->session->userdata('mc20bt99_membership_transaction_insert_id'))) {
    $this->session->unset_userdata('mc20bt99_membership_transaction_insert_id');
}
?>
