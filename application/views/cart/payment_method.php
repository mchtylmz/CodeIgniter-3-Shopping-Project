                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <ul class="payment-options-list">
                                                    ...
                                                    <?php endif; ?>
                                                    <?php if ($this->auth_check == 1 && $this->payment_settings->cash_on_delivery_enabled && empty($cart_has_digital_product) && $mc20bt99_payment_type == "sale"): ?>
                                                        <li>
                                                            <div class="option-payment">
                                                                <div class="custom-control custom-radio">
                                            ...
                                            <div class="form-group m-t-15">
                                                <?php if ($mc20bt99_payment_type == "sale"): ?>
