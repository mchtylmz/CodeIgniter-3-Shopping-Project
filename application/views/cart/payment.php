                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-8">
                            <div class="left">
                                ...
                                <?php endif; ?>
                                <?php if (!empty($cart_has_physical_product) && $this->product_settings->marketplace_shipping == 1 && $mc20bt99_payment_type == "sale"): ?>
                                ...
                                <div class="tab-checkout tab-checkout-closed">
                                    <?php if ($mc20bt99_payment_type == "membership" || $mc20bt99_payment_type == "promote"): ?>
                                        <a href="<?php echo generate_url("cart", "payment_method"); ?>?payment_type=<?= $mc20bt99_payment_type; ?>"><h2 class="title">
                                                <?php if (!empty($cart_has_physical_product) && $mc20bt99_payment_type == "sale") {
                                                    echo '2.';
                                                } else {
                                                    echo '1.';
                                                } ?>
                                                &nbsp;<?php echo trans("payment_method"); ?></h2></a>
                                        <a href="<?php echo generate_url("cart", "payment_method"); ?>?payment_type=<?= $mc20bt99_payment_type; ?>" class="link-underlined"><?php echo trans("edit"); ?></a>
                                    <?php else: ?>
                                ...
                                <div class="tab-checkout tab-checkout-open">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <?php
                                            $data = array('total_amount' => $total_amount, 'currency' => $currency, 'mc20bt99_payment_type' => $mc20bt99_payment_type, 'cart_total' => $cart_total, 'mc20bt99_payment_token' => generate_token());
                                            ...
                                            if ($cart_payment_method->payment_option == "bank_transfer") {
                                                ...
                                                $sess_data->mc20bt99_payment_token = $data['mc20bt99_payment_token'];
                                                $sess_data->currency = $data['currency'];
                                                $sess_data->total_amount = $data['total_amount'];
                                                $sess_data->payment_type = $mc20bt99_payment_type;
                                                $this->session->set_userdata('mc20bt99_payment_cart_data', $sess_data);
                                                //load view
                                                if (empty($cart_payment_method->payment_option)) {
                        ...
                        <?php if ($mc20bt99_payment_type == 'membership'):
                            $this->load->view("cart/_order_summary_membership");
                        elseif ($mc20bt99_payment_type == 'promote'):
