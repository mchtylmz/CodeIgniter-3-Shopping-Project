                        ...
                        <div class="col-sm-12 col-lg-8">
                            <div class="left">
                                ...
                                <div class="tab-checkout tab-checkout-open m-t-0">
                                    ...
                                    $mc20bt99_cart_shipping = get_sess_data('mc20bt99_cart_shipping');
                                    $show_billing_form = 0;
                                    if (empty($mc20bt99_cart_shipping)) {
                                        $show_billing_form = 0;
                                    } else {
                                        if (empty($mc20bt99_cart_shipping->use_same_address_for_billing)) {
                                            $show_billing_form = 1;
                                        }
                                    }
                                    ...
                                    if (!empty($mc20bt99_cart_shipping)):
                                        if (!empty($mc20bt99_cart_shipping->guest_shipping_address)):
                                            $shipping_address = $mc20bt99_cart_shipping->guest_shipping_address;
                                        endif;
                                        if (!empty($mc20bt99_cart_shipping->guest_billing_address)):
                                            $billing_address = $mc20bt99_cart_shipping->guest_billing_address;
                                        endif;
                                    endif; ?>
                                    <div class="row">
