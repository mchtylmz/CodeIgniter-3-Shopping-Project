        ...
        <div class="col-sm-12">
            ...
            <?php if ($selected_option == "flat_rate"): ?>
                <div class="response-shipping-method">
                    <span class="title"><?= trans($selected_option); ?></span>
                                ...
                                <div class="modal-body">
                                    <div class="form-group m-b-10">
                                        ...
                                        <?php foreach ($this->languages as $language): ?>
                                            <input type="text" name="method_name_<?= $option_unique_id; ?>_lang_<?= $language->id; ?>" class="form-control form-input m-b-5" value="<?= trans($selected_option); ?>" placeholder="<?= $language->name; ?>" maxlength="255">
                                        <?php endforeach; ?>
                                    </div>
                                    ...
                                    <div class="form-group m-b-10">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="flat_rate_cost_<?= $option_unique_id; ?>" class="form-control form-input price-input" placeholder="<?php echo $this->input_initial_price; ?>" maxlength="19">
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-custom-option">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" name="status_<?= $option_unique_id; ?>" value="1" id="status_<?= $option_unique_id; ?>_1" class="custom-control-input" checked>
                                                    <label for="status_<?= $option_unique_id; ?>_1" class="custom-control-label"><?= trans("enable"); ?></label>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12 col-custom-option">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" name="status_<?= $option_unique_id; ?>" value="0" id="status_<?= $option_unique_id; ?>_2" class="custom-control-input">
                    ...
                    <div class="btn-group btn-group-option">
                        ...
                        <a href="javascript:void(0)" class="btn btn-sm btn-default btn-delete-shipping-method" data-toggle="tooltip" title="<?= trans('delete'); ?>"  data-id="<?= $option_unique_id; ?>"><i class="fa fa-trash-o"></i></a>
                    </div>
                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group m-b-10">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><?= $this->default_currency->symbol; ?></span>
                                            <input type="text" name="local_pickup_cost_<?= $option_unique_id; ?>" class="form-control form-input price-input" placeholder="<?php echo $this->input_initial_price; ?>" maxlength="19">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group m-b-10">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><?= $this->default_currency->symbol; ?></span>
                                            <input type="text" name="free_shipping_min_amount_<?= $option_unique_id; ?>" class="form-control form-input price-input" placeholder="<?php echo $this->input_initial_price; ?>" maxlength="19">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
