                        ...
                        <?php if (!empty($transactions)): ?>
                            <?php foreach ($transactions as $transaction): ?>
                                <tr>
                                    ...
                                    <td><?= html_escape($transaction->plan_title); ?></td>
                                    ...
                                    <td><a href="<?php echo lang_base_url(); ?>invoice-membership/<?= $transaction->id; ?>" class="btn btn-sm btn-info" target="_blank"><i class="fa fa-file-text"></i>&nbsp;&nbsp;<?php echo trans("view_invoice"); ?></a></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
                        </tbody>
