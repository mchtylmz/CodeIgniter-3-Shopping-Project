    ...
    <aside class="main-sidebar" style="background-color: #343B4A;">
        ...
        <section class="sidebar sidebar-scrollbar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="nav-earnings<?php is_admin_nav_active(['earnings']); ?>">
                ...
                */ ?>
                ...
                <li class="header"><?php echo trans("members"); ?></li>
                <li class="treeview<?php is_admin_nav_active(['add-administrator', 'administrators', 'vendors', 'members', 'edit-user', 'onesignal']); ?>">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        ...
                        */ ?>
                        ...
                        <li class="nav-onesignal"><a href="<?php echo admin_url(); ?>onesignal"> <?php echo trans("send_notification"); ?></a></li>
                        <?php endif; ?>
                    ...
                    <ul class="treeview-menu">
                        ...
                        */ ?>
                        ...
                        <li class="nav-nebim-settings">
                          <a href="<?php echo admin_url(); ?>nebim-settings"> <?php echo trans("nebim_settings"); ?></a>
                        </li>
                        <?php endif; ?>
                        <li class="nav-languages">
                          <a href="<?php echo admin_url(); ?>languages"> <?php echo trans("language_settings"); ?></a>
                        </li>
                        <li class="nav-email-settings">
                          <a href="<?php echo admin_url(); ?>email-settings"> <?php echo trans("email_settings"); ?></a>
                        </li>
                        <li class="nav-product-settings">
                            <a href="<?php echo admin_url(); ?>product-settings"><?php echo trans("product_settings"); ?></a>
                        </li>
                        <li class="nav-social-login">
                          <a href="<?php echo admin_url(); ?>social-login"> <?php echo trans("social_login"); ?></a>
                        </li>

                        <li class="treeview<?php is_admin_nav_active([
                          'storage', 'cache-system', 'seo-tools', 'ad-spaces'
                        ]); ?>">
                            <a href="#">
                                <i class="fa fa-cloud-upload"></i>
                                <span><?php echo trans("management_tools"); ?></span>
                                <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                            </a>
                            <ul class="treeview-menu">
                              <?php /*
                              <li class="nav-storage">
                                  <a href="<?php echo admin_url(); ?>storage"><?php echo trans("storage"); ?></a>
                              </li>
                              */ ?>
                              <li class="nav-cache-system">
                                  <a href="<?php echo admin_url(); ?>cache-system"><?php echo trans("cache_system"); ?></a>
                              </li>
                              <li class="nav-seo-tools">
                                  <a href="<?php echo admin_url(); ?>seo-tools"><?php echo trans("seo_tools"); ?></a>
                              </li>
                            </ul>
                        </li>

                        <li class="treeview<?php is_admin_nav_active([
                          'payment-settings', 'currency-settings'
                        ]); ?>">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li class="nav-payment-settings">
                                  <a href="<?php echo admin_url(); ?>payment-settings"> <?php echo trans("payment_settings"); ?></a>
                                </li>
                                <li class="nav-currency-settings">
                                  <a href="<?php echo admin_url(); ?>currency-settings"> <?php echo trans("currency_settings"); ?></a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="treeview<?php is_admin_nav_active(['visual-settings', 'font-settings']); ?>">
                            ...
                            <ul class="treeview-menu">
                                <li class="nav-visual-settings">
                                  <a href="<?php echo admin_url(); ?>visual-settings"> <?php echo trans("visual_settings"); ?></a>
                                </li>
                                <li class="nav-font-settings">
                                  <a href="<?php echo admin_url(); ?>font-settings"> <?php echo trans("font_settings"); ?></a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="treeview<?php is_admin_nav_active(['system-settings', 'route-settings']); ?>">
                            ...
                            <ul class="treeview-menu">
                                <li class="nav-system-settings">
                                  <a href="<?php echo admin_url(); ?>system-settings"> <?php echo trans("system_settings"); ?></a>
                                </li>
                                <li class="nav-route-settings">
                                  <a href="<?php echo admin_url(); ?>route-settings"> <?php echo trans("route_settings"); ?></a>
                                </li>
                            </ul>
                        </li>
