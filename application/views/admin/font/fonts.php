    ...
    <div class="col-lg-5 col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label class="label-sitemap"><?php echo trans('dashboard_font'); ?></label>
                    <select name="dashboard_font" class="form-control custom-select">
                        <?php foreach ($fonts as $font): ?>
                            <option value="<?php echo $font->id; ?>" <?php echo ($settings->dashboard_font == $font->id) ? 'selected' : ''; ?>><?php echo $font->font_name; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)" onclick="delete_item('settings_controller/delete_font_post','<?php echo $font->id; ?>','<?php echo trans("confirm_delete"); ?>');"><i class="fa fa-trash option-icon"></i><?php echo trans('delete'); ?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
