    ...
    <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li class=""><a href="#tab_8" data-toggle="tab" aria-expanded="false">Onesignal</a></li>
            </ul>
            <div class="tab-content settings-tab-content">
                ...
                <div class="tab-pane" id="tab_8">
                  ...
                  <div class="form-group">
                      <label class="control-label">Onesignal APP ID</label>
                      <input type="text" class="form-control" name="onesignal_app_id"
                             placeholder="XXXXXXX" value="<?php echo html_escape($this->general_settings->onesignal_app_id ?? ''); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                  </div>

                  <div class="form-group">
                      <label class="control-label">Onesignal REST API</label>
                      <input type="text" class="form-control" name="onesignal_key"
                             placeholder="XXXXX..." value="<?php echo html_escape($this->general_settings->onesignal_key ?? ''); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                  </div>

                  <div class="form-group">
                      <label class="control-label">Onesignal <?php echo trans('admin'); ?> Player ID</label>
                             <textarea class="form-control" name="onesignal_player_id" placeholder="XXX, XXX, XXX,..." rows="4" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>><?php echo html_escape($this->general_settings->onesignal_player_id ?? ''); ?></textarea>
                      <small><?php echo trans('onesignal_playerid_info'); ?></small>
                  </div>

                  <div class="form-group">
                      <div class="row">
                          <div class="col-sm-12 col-xs-12">
                              <label>Onesignal Test Mod (Developer Mod)</label>
                          </div>
                          <div class="col-sm-6 col-xs-12 col-option">
                              <input type="radio" id="onesignal_test_mode_1" name="onesignal_test_mode" value="1" class="square-purple" <?php echo ($this->general_settings->onesignal_test_mode == "1") ? 'checked' : ''; ?>>
                              <label for="onesignal_test_mode_1" class="cursor-pointer"><?php echo trans("enable"); ?></label>
                          </div>
                          <div class="col-sm-6 col-xs-12 col-option">
                              <input type="radio" id="onesignal_test_mode_2" name="onesignal_test_mode" value="0" class="square-purple" <?php echo ($this->general_settings->onesignal_test_mode != "1") ? 'checked' : ''; ?>>
                              <label for="onesignal_test_mode_2" class="cursor-pointer"><?php echo trans("disable"); ?></label>
                          </div>
                      </div>
                  </div>
