...
<div class="row">
    ...
    */ ?>
    <!-- paynet -->
    <div class="col-lg-6 col-md-12">
        <?php $paynet = get_payment_gateway('paynet');
        if (!empty($paynet)):?>
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><?= $paynet->name; ?></h3>
                </div>
                <?php echo form_open('settings_controller/payment_gateway_settings_post'); ?>
                <input type="hidden" name="name_key" value="paynet">
                <div class="box-body">
                    <img src="https://www.paynet.com.tr/themes/custom/paynet/logo.svg" alt="paynet" class="img-payment-logo">
                    <?php if (!empty($this->session->flashdata("mes_paynet"))):
                        $this->load->view('admin/includes/_messages');
                    endif; ?>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-option">
                                <div class="custom-control custom-radio">
                                    <input type="radio" name="status" value="1" id="status_paynet_1" class="custom-control-input" <?= $paynet->status == 1 ? 'checked' : ''; ?>>
                                    <label for="status_paynet_1" class="custom-control-label"><?php echo trans("enable"); ?></label>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-12 col-option">
                                <div class="custom-control custom-radio">
                                    <input type="radio" name="status" value="0" id="status_paynet_2" class="custom-control-input" <?= $paynet->status != 1 ? 'checked' : ''; ?>>
                                    <label for="status_paynet_2" class="custom-control-label"><?php echo trans("disable"); ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-option">
                                <div class="custom-control custom-radio">
                                    <input type="radio" name="environment" value="production" id="environment_paynet_1" class="custom-control-input" <?= $paynet->environment == 'production' ? 'checked' : ''; ?>>
                                    <label for="environment_paynet_1" class="custom-control-label"><?php echo trans("production"); ?></label>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-12 col-option">
                                <div class="custom-control custom-radio">
                                    <input type="radio" name="environment" value="sandbox" id="environment_paynet_2" class="custom-control-input" <?= $paynet->environment != 'production' ? 'checked' : ''; ?>>
                                    <label for="environment_paynet_2" class="custom-control-label"><?php echo trans("sandbox"); ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label"><?= trans("api_key"); ?></label>
                        <input type="text" class="form-control" name="public_key" placeholder="<?= trans("api_key"); ?>" value="<?= $paynet->public_key; ?>">
                    </div>
                    <div class="form-group">
                        <label class="control-label"><?= trans("secret_key"); ?></label>
                        <input type="text" class="form-control" name="secret_key" placeholder="<?= trans("secret_key"); ?>" value="<?= $paynet->secret_key; ?>">
                    </div>
                    <div class="form-group">
                        <label class="control-label">Nebim V3</label>
                        <input type="text" class="form-control" name="nebim_v3" placeholder="..." value="<?= $paynet->nebim_v3 ?? ''; ?>">
                    </div>
                    <?php if (!empty($currencies)): ?>
                        <div class="form-group">
                            <label class="control-label"><?= trans("base_currency"); ?></label>
                            <select name="base_currency" class="form-control">
                                <?php foreach ($currencies as $currency):
                                    if ($currency->code == "TRY"):?>
                                        <option value="<?= $currency->code; ?>" <?= $paynet->base_currency == $currency->code ? 'selected' : ''; ?>><?= $currency->code; ?>&nbsp;(<?= $currency->name; ?>)</option>
                                    <?php endif;
                                endforeach; ?>
                            </select>
                        </div>
