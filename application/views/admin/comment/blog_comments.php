...
<div class="row" style="margin-bottom: 15px;">
    <div class="col-sm-12">
        <h3 style="font-size: 18px; font-weight: 600;"><?php echo trans('blog_comments'); ?></h3>
    </div>
</div>
<div class="box">
                    ...
                    <div class="row">
                        <div class="pull-left">
                            ...
                            <?php if ($show_approve_button == true): ?>
                                <button class="btn btn-sm btn-success btn-table-delete" onclick="approve_selected_blog_comments();"><?php echo trans('approve'); ?></button>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
