...
<div class="row" style="margin-bottom: 15px;">
    <div class="col-sm-12">
        <h3 style="font-size: 18px; font-weight: 600;"><?php echo trans('product_comments'); ?></h3>
    </div>
</div>
<div class="box">
    <div class="box-header with-border">
        ...
        <div class="right">
            <a href="<?php echo $top_button_url; ?>" class="btn btn-success btn-add-new">
                <i class="fa fa-bars"></i>&nbsp;&nbsp;<?php echo $top_button_text; ?>
            </a>
        </div>
    </div><!-- /.box-header -->
                    ...
                    <table class="table table-bordered table-striped data_table" role="grid" aria-describedby="example1_info">
                        ...
                        <?php foreach ($comments as $item): ?>
                            <tr>
                                ...
                                <td>
                                    <?php $product = get_active_product($item->product_id);
                                    if (!empty($product)): ?>
                                ...
                                <td>
                                    <?php echo form_open('product_controller/approve_comment_post'); ?>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu options-dropdown">
                                            ...
                                            <?php endif; ?>
                                            <li>
                                                <a href="javascript:void(0)" onclick="delete_item('product_controller/delete_comment','<?php echo $item->id; ?>','<?php echo trans("confirm_comment"); ?>');"><i class="fa fa-trash option-icon"></i><?php echo trans('delete'); ?></a>
                                            </li>
                                        </ul>
                                    </div>
