			...
			<div class="box-body">
				...
				<div class="form-group">
					...
					<select name="frequency" class="form-control">
						<option value="none" <?php echo ($this->product_settings->sitemap_frequency == 'none') ? 'selected' : ''; ?>><?php echo trans('none'); ?></option>
						<option value="always" <?php echo ($this->product_settings->sitemap_frequency == 'always') ? 'selected' : ''; ?>><?php echo trans('always'); ?></option>
						<option value="hourly" <?php echo ($this->product_settings->sitemap_frequency == 'hourly') ? 'selected' : ''; ?>><?php echo trans('hourly'); ?></option>
						<option value="daily" <?php echo ($this->product_settings->sitemap_frequency == 'daily') ? 'selected' : ''; ?>><?php echo trans('daily'); ?></option>
						<option value="weekly" <?php echo ($this->product_settings->sitemap_frequency == 'weekly') ? 'selected' : ''; ?>><?php echo trans('weekly'); ?></option>
						<option value="monthly" <?php echo ($this->product_settings->sitemap_frequency == 'monthly') ? 'selected' : ''; ?>><?php echo trans('monthly'); ?></option>
						<option value="yearly" <?php echo ($this->product_settings->sitemap_frequency == 'yearly') ? 'selected' : ''; ?>><?php echo trans('yearly'); ?></option>
						<option value="never" <?php echo ($this->product_settings->sitemap_frequency == 'never') ? 'selected' : ''; ?>><?php echo trans('never'); ?></option>
					</select>
				</div>
				...
				<div class="form-group">
					...
					<p>
						<input type="radio" name="last_modification" id="last_modification_1" value="none" class="square-purple" <?php echo ($this->product_settings->sitemap_last_modification == 'none') ? 'checked' : ''; ?>>
						<label for="last_modification_1" class="cursor-pointer">&nbsp;<?php echo trans('none'); ?></label>
					</p>
					<p>
						<input type="radio" name="last_modification" id="last_modification_2" value="server_response" class="square-purple" <?php echo ($this->product_settings->sitemap_last_modification == 'server_response') ? 'checked' : ''; ?>>
				...
				<div class="form-group">
					...
					<p>
						<input type="radio" name="priority" id="priority_1" value="none" class="square-purple" <?php echo ($this->product_settings->sitemap_priority == 'none') ? 'checked' : ''; ?>>
						<label for="priority_1" class="cursor-pointer">&nbsp;<?php echo trans('none'); ?></label>
					</p>
					<p>
						<input type="radio" name="priority" id="priority_2" value="automatically" class="square-purple" <?php echo ($this->product_settings->sitemap_priority == 'automatically') ? 'checked' : ''; ?>>
