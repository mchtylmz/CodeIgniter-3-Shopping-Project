...
<div class="row">
    <div class="col-sm-12">
        <div class="box box-primary">
            ...
            <div class="box-body box-body-ad-spaces">
                        ...
                        <div class="row row-ad-space">
                            <div class="col-sm-6">
                                ...
                                <textarea class="form-control text-area-adspace" name="ad_code_250"
                                          placeholder="<?php echo trans('paste_ad_code'); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>><?php echo $ad_codes->ad_code_250; ?></textarea>
                            </div>
                            <div class="col-sm-6">
                                <label class="control-label"><?php echo trans('upload_your_banner'); ?></label>
                                <input type="text" class="form-control" name="url_ad_code_250" placeholder="<?php echo trans('paste_ad_url'); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                                <div class="row m-t-15">
                                    <div class="col-sm-12">
                                        <a class='btn bg-olive btn-sm btn-file-upload'>
                                            <?php echo trans('select_image'); ?>
...
<div class="row">
    <div class="col-lg-6 col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo trans('google_adsense_code'); ?><br><small><?php echo html_escape(trans("adsense_head_exp")); ?></small></h3>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <textarea name="google_adsense_code" class="form-control" placeholder="<?php echo trans('google_adsense_code'); ?>" style="min-height: 140px;"><?php echo $this->general_settings->google_adsense_code; ?></textarea>
                </div>
            </div>
...
<?php if ($this->site_lang->text_direction == "rtl"): ?>
    <style>
        h4 {
            text-align: right;
        }
