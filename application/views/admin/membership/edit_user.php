    ...
    <div class="col-sm-8">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <hr>
                <div class="form-group">
                    <label class="control-label"><?php echo trans('nebim_user_code'); ?></label>
                    <input type="text" class="form-control form-input" name="curr_acc_code" placeholder="1-4-.."
                           value="<?php echo html_escape($user->curr_acc_code); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>
                <div class="form-group">
                    <label class="control-label"><?php echo trans('onesignal_id'); ?></label>
                    <input type="text" class="form-control form-input" name="onesignal_id" placeholder="XXXXXXXXXX.."
                           value="<?php echo html_escape($user->onesignal_id); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>
