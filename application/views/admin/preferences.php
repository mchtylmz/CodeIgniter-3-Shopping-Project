        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            <label><?= trans("nebim_api"); ?></label>
                            <medium><?php echo "(" . trans('nebim_api_information') . ")"; ?></medium>
                        </div>
                        <div class="col-sm-6 col-xs-12 col-option">
                            <input type="radio" id="nebim_status_1" name="nebim_status" value="1" class="square-purple" <?php echo ($this->general_settings->nebim_status == "1") ? 'checked' : ''; ?>>
                            <label for="nebim_status_1" class="cursor-pointer"><?php echo trans("enable"); ?></label>
                        </div>
                        <div class="col-sm-6 col-xs-12 col-option">
                            <input type="radio" id="nebim_status_2" name="nebim_status" value="0" class="square-purple" <?php echo ($this->general_settings->nebim_status != "1") ? 'checked' : ''; ?>>
                            <label for="nebim_status_2" class="cursor-pointer"><?php echo trans("disable"); ?></label>
                        </div>
                    </div>
                </div>
