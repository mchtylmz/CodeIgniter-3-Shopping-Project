...
class Location_model extends CI_Model
{
    ...
    public function add_country()
    {
        ...
        if (active_nebimv3()) {
          $data['nebim'] = $this->input->post('nebim', true);
        }
    ...
    //get countries
    public function get_countries(int $status = 1)
    {
    ...
    public function get_paginated_countries($per_page, $offset)
    {
        ...
        if ($this->input->get('status', true) == '0' || $this->input->get('status', true) == '1') {
          $this->db->where('status', clean_number($this->input->get('status', true)));
        } elseif($this->input->get('status', true) != '2') {
    ...
    public function get_paginated_states($per_page, $offset)
    {
        ...
        if ($this->input->get('status', true) == '0' || $this->input->get('status', true) == '1') {
          $this->db->where('location_countries.status', clean_number($this->input->get('status', true)));
        } elseif($this->input->get('status', true) != '2') {
    ...
    public function get_default_location()
    {
        ...
        $location->state_id = "";
        $location->city_id = "";
        $sess_location = $this->session->userdata('mc20bt99_default_location');
    ...
    public function set_default_location()
    {
        ...
        $this->session->set_userdata('mc20bt99_default_location', serialize($location));
    }
