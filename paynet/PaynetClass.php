...
{ 	private $isLive;
    ...
    private function LoadJson($adres_eki, $data)
    {
		if(self::IsFileGetContentsActive())
		{
			...
			$result = json_decode(file_get_contents($this->PaynetUrl.$adres_eki, false, $context));
	...
	*/
	 ...
	 */
	public function Payment(PaymentParameters $params)
	{
		$this->json_result = $this->LoadJson("v2/transaction/payment", $params);
		$sonuc = new PaymentResult();
		$sonuc->fillFromJson($this->json_result);
		return $sonuc;
	}
     ...
     /**
	 * 
	 * @param TdsInitialParameters $params
	 * @return TdsInitialResult
	 */
	public function TdsInitial(TdsInitialParameters $params)
	{
		$this->json_result = $this->LoadJson("v2/transaction/tds_initial", $params);
		$sonuc = new TdsInitialResult();
		$sonuc->fillFromJson($this->json_result);
		return $sonuc;
	}
	 ...
	 /**
	 * 
	 * @param TdsChargeParameters $params
	 * @return TdsChargeResult
	 */
	public function TdsCharge(TdsChargeParameters $params)
	{
		$this->json_result = $this->LoadJson("v2/transaction/tds_charge", $params);
		$sonuc = new TdsChargeResult();
		$sonuc->fillFromJson($this->json_result);
		return $sonuc;
	}
...
/**
 * Sunucudan dönen cevaplar için base sınıf
 * @author proje
 */
...
class MailOrderParameters
{
	...
	public function __construct()
	{
		...
		$this->send_confirmation_mail = true;
...
class PaymentBaseParameters
{
    ...
    public $pos_type;
    public $company_amount;
    public $add_commission;
    public $ratio_code;
    public $instalment;
    public $merge_option;
    public $ratio_code_method;
    public $domain;
    public $approved_card;
    public $dont_apply_campaign;
    public $is_escrow;
    public $iban;
    public $agent_customer_name;
    public $card_holder;
    public $card_hash;
    public $pan;
    public $month;
    public $year;
    public $cvc;
    public $card_holder_phone;
    public $card_holder_mail;
    public $description;
    public $save_card;
    public $card_owner_id;
	...
	{
		$this->pos_type = 5;
		$this->add_commission = false;
		$this->instalment = 0;
		$this->merge_option = false;
		$this->approved_card = false;
		$this->dont_apply_campaign = false;
		$this->is_escrow = false;
...
class PaymentBaseResult extends Result
{
	public $id;
	public $xact_id;
	public $xact_date;
	...
	public $bank_id;
	public $bank_name;
	public $bank_authorization_code;
	public $bank_reference_code;
	...
	public $campaign_url;
	public $end_user_comission;
	public $end_user_ratio;
	public $ratio_code;
	public $ratio_code_method;
	public $card_brand_name;
	public $card_type;   
	public $plus_installment;
	public $company_cost_ratio;
	...
	public $is_save_card_succeed;
	public $save_card_result_message;
	public $card_owner_id;
	public $user_unique_id;
	public $card_hash;
	public $card_bank_id;
	public $card_logo_url;
}

class PaymentParameters extends PaymentBaseParameters
{
	public $transaction_type;
...
class PaymentResult extends PaymentBaseResult
{
}

class TdsInitialParameters extends PaymentBaseParameters
{
	public $return_url;
}


class TdsInitialResult extends Result
{
    public $token_id;
    public $session_id;
    public $post_url;
...
class TdsChargeResult extends PaymentBaseResult
{
	public $is_tds;
    public $md_status;
}
...
/**
 * Hata oluştuğunda dönecek class
 * @author proje
 *
 */
...
class PaynetTools {
	...
	public static function FormatWithDecimalSeperator($amount)
	{
		...
		{
			Throw new PaynetException("Tutar sayısal değer olmalı.");		
		}
